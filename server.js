...
const EXPANDED_DEMO_POSTS = [
  ...
  {
    title: "Tuyển nhân viên môi giới căn hộ cho thuê khu Phan Văn Trị",
    category: "Việc làm",
    price: 14000000,
    location: "Gò Vấp - Phan Văn Trị",
    description: "Tìm nhân viên tư vấn căn hộ dịch vụ, phòng trọ và nhà nguyên căn. Có nguồn tin sẵn, được hướng dẫn cách lọc nhu cầu, đặt lịch xem và chăm sóc khách thuê.",
  ...
  {
    title: "Tuyển nhân viên nhập liệu tin nhà đất Gò Vấp làm tại văn phòng",
    category: "Việc làm",
    price: 8500000,
    location: "Gò Vấp - Phường 1",
    description: "Công việc gồm nhập thông tin tin đăng, kiểm tra hình ảnh, cập nhật trạng thái còn hàng và hỗ trợ đội kinh doanh quản lý danh sách nhà đất.",
  ...
  {
    title: "Tuyển trợ lý kinh doanh bất động sản khu Nguyễn Kiệm",
    category: "Việc làm",
    price: 12000000,
    location: "Gò Vấp - Nguyễn Kiệm",
    description: "Hỗ trợ đặt lịch xem nhà, chuẩn bị hồ sơ tin đăng, chăm sóc khách cũ và theo dõi tiến độ giao dịch. Ưu tiên ứng viên cẩn thận, giao tiếp rõ ràng.",
    image: "https://images.unsplash.com/photo-1551836022-b06985bceb24?auto=format&fit=crop&w=1200&q=80",
    area: 0,
    bedrooms: 0,
    house_direction: "",
    legal_status: "Toàn thời gian",
    is_featured: 0,
    views: 176
  },
  {
    title: "Tuyển cộng tác viên tìm nguồn phòng trọ Gò Vấp thu nhập linh hoạt",
    category: "Việc làm",
    price: 7000000,
    location: "Gò Vấp - Linh hoạt",
    description: "Phù hợp người rành khu vực Gò Vấp. Công việc khảo sát phòng trống, lấy thông tin chủ nhà, chụp ảnh thực tế và gửi dữ liệu về hệ thống.",
    image: "https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=1200&q=80",
    area: 0,
    bedrooms: 0,
    house_direction: "",
    legal_status: "Làm thêm linh hoạt",
    is_featured: 0,
    views: 164
  },
  {
    title: "Tuyển nhân viên quay chụp nhà đất bằng điện thoại tại Gò Vấp",
    category: "Việc làm",
    price: 10000000,
    location: "Gò Vấp - Phường 15",
    description: "Chụp ảnh, quay video ngắn nhà bán, căn hộ cho thuê và mặt bằng kinh doanh. Có hướng dẫn góc chụp, checklist nội dung và phụ cấp di chuyển.",
    image: "https://images.unsplash.com/photo-1492724441997-5dc865305da7?auto=format&fit=crop&w=1200&q=80",
    area: 0,
    bedrooms: 0,
    house_direction: "",
    legal_status: "Có phụ cấp di chuyển",
    is_featured: 1,
    views: 221
  },
  {
    title: "Tuyển chuyên viên tư vấn mua bán nhà phố khu Lê Đức Thọ",
    category: "Việc làm",
    price: 18000000,
    location: "Gò Vấp - Lê Đức Thọ",
    description: "Tư vấn khách mua ở thật và khách đầu tư nhà phố. Được hỗ trợ data, nguồn sản phẩm, kịch bản tư vấn và quy trình chăm sóc sau khi xem nhà.",
    image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=1200&q=80",
    area: 0,
    bedrooms: 0,
    house_direction: "",
    legal_status: "Ưu tiên có kinh nghiệm",
    is_featured: 1,
    views: 244
  },
  {
    title: "Tuyển nhân viên trực chat khách thuê nhà Gò Vấp ca tối",
    category: "Việc làm",
    price: 6500000,
    location: "Gò Vấp - Làm bán thời gian",
    description: "Trực tin nhắn Zalo, Facebook, website vào buổi tối. Tư vấn thông tin phòng, lọc nhu cầu cơ bản và chuyển khách tiềm năng cho nhân viên dẫn xem.",
  ...
  {
    title: "Tuyển nhân viên sale mặt bằng kinh doanh Gò Vấp",
    category: "Việc làm",
    price: 16000000,
    location: "Gò Vấp - Quang Trung",
    description: "Phụ trách khách thuê mặt bằng, shop, văn phòng nhỏ và spa. Cần kỹ năng tư vấn vị trí, giá thuê, diện tích và điều kiện hợp đồng rõ ràng.",
    image: "https://images.unsplash.com/photo-1556761175-129418cb2dfe?auto=format&fit=crop&w=1200&q=80",
    area: 0,
    bedrooms: 0,
    house_direction: "",
    legal_status: "Lương + thưởng giao dịch",
    is_featured: 0,
    views: 187
  },
  {
    title: "Tuyển nhân viên hành chính hỗ trợ hồ sơ nhà đất Gò Vấp",
    category: "Việc làm",
    price: 10500000,
    location: "Gò Vấp - Văn phòng",
    description: "Sắp xếp hồ sơ, lưu thông tin pháp lý, hỗ trợ kiểm tra giấy tờ cơ bản và cập nhật tình trạng tin đăng. Phù hợp người cẩn thận, làm việc ổn định.",
    image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=1200&q=80",
    area: 0,
    bedrooms: 0,
    house_direction: "",
    legal_status: "Hành chính văn phòng",
    is_featured: 0,
    views: 171
  },
  {
    title: "Tuyển leader đội đăng tin bất động sản Gò Vấp",
    category: "Việc làm",
    price: 17000000,
    location: "Gò Vấp - Phường 10",
    description: "Quản lý nhóm đăng tin, phân chia nguồn hàng, kiểm tra chất lượng nội dung và theo dõi hiệu quả hiển thị. Cần kinh nghiệm vận hành đội nhóm nhỏ.",
    image: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=1200&q=80",
    area: 0,
    bedrooms: 0,
    house_direction: "",
    legal_status: "Leader nhóm",
    is_featured: 1,
    views: 229
  },
  {
    title: "Tuyển nhân viên tư vấn khách mua đất nền vùng ven TP.HCM",
    category: "Việc làm",
    price: 15000000,
    location: "Gò Vấp - TP.HCM",
    description: "Tư vấn khách có nhu cầu mua đất nền, lọc tài chính, khu vực quan tâm và pháp lý. Có tài liệu đào tạo về quy trình tư vấn an toàn, rõ thông tin.",
    image: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=1200&q=80",
    area: 0,
    bedrooms: 0,
    house_direction: "",
    legal_status: "Đào tạo từ đầu",
    is_featured: 0,
    views: 166
  },
  {
    title: "Tuyển nhân viên marketing chạy nội dung nhà đất Gò Vấp",
    category: "Việc làm",
    price: 13500000,
    location: "Gò Vấp - Phường 6",
    description: "Viết nội dung ngắn cho tin nhà đất, tối ưu tiêu đề, chọn hình ảnh và theo dõi phản hồi khách hàng. Ưu tiên biết Canva, Facebook và Zalo OA.",
    image: "https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?auto=format&fit=crop&w=1200&q=80",
    area: 0,
    bedrooms: 0,
    house_direction: "",
    legal_status: "Marketing nội dung",
    is_featured: 0,
    views: 159
  },
  {
